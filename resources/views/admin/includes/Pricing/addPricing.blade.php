...
<form action="{{route('storepricing')}}" method="post" class="form-horizontal" enctype="multipart/form-data">
    {{csrf_field()}}
    <div class="control-group">
        <label class="control-label">Pricing Title :</label>
        <div class="controls">
            <input class="span11" name="pricing_title" value="{{old('pricing_title')}}" placeholder="Pricing Title" type="text">
        </div>
    </div>
    <div class="control-group">
        <label class="control-label">Pricing Core Features</label>
        <div class="controls">
            <textarea class="textarea_editor span10" name="pricing_core_features"  placeholder="Core Features">{{old('pricing_core_features')}}</textarea>
        </div>
    </div>
    <div class="control-group">
